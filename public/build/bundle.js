...
var app = (function () {
    ...
    /* src/components/DashboardInfo.svelte generated by Svelte v3.31.2 */
    const file = "src/components/DashboardInfo.svelte";
    ...
    function create_fragment(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(svg, "viewBox", "0 0 512.009 512.009");
    			set_style(svg, "enable-background", "new 0 0 512.009 512.009");
    			attr_dev(svg, "xml:space", "preserve");
    			add_location(svg, file, 36, 8, 854);
    			attr_dev(span0, "class", "header__left-heading svelte-8rgi1h");
    			add_location(span0, file, 35, 6, 810);
    			attr_dev(div0, "class", "info__upper-left");
    			add_location(div0, file, 34, 4, 773);
    			add_location(p, file, 104, 6, 5130);
    			attr_dev(div1, "class", "info__upper-right");
    			add_location(div1, file, 103, 4, 5092);
    			attr_dev(div2, "class", "info__upper svelte-8rgi1h");
    			add_location(div2, file, 33, 2, 743);
    			attr_dev(span1, "class", "header__left-heading-price svelte-8rgi1h");
    			add_location(span1, file, 109, 6, 5230);
    			attr_dev(span2, "class", span2_class_value = "" + (null_to_empty(/*isNegative*/ ctx[0] ? "positive" : "negative") + " svelte-8rgi1h"));
    			add_location(span2, file, 110, 6, 5300);
    			attr_dev(div3, "class", "info__lower-left svelte-8rgi1h");
    			add_location(div3, file, 108, 4, 5193);
    			attr_dev(label0, "for", "");
    			attr_dev(label0, "class", "svelte-8rgi1h");
    			add_location(label0, file, 116, 8, 5484);
    			add_location(div4, file, 117, 8, 5522);
    			attr_dev(div5, "class", "svelte-8rgi1h");
    			add_location(div5, file, 115, 6, 5470);
    			attr_dev(label1, "for", "");
    			attr_dev(label1, "class", "svelte-8rgi1h");
    			add_location(label1, file, 120, 8, 5578);
    			add_location(div6, file, 121, 8, 5615);
    			attr_dev(div7, "class", "svelte-8rgi1h");
    			add_location(div7, file, 119, 6, 5564);
    			attr_dev(div8, "class", "info__lower-right svelte-8rgi1h");
    			add_location(div8, file, 114, 4, 5432);
    			attr_dev(div9, "class", "info__lower svelte-8rgi1h");
    			add_location(div9, file, 107, 2, 5163);
    			attr_dev(div10, "class", "info svelte-8rgi1h");
    			add_location(div10, file, 32, 0, 722);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*isNegative*/ 1 && t7_value !== (t7_value = (/*isNegative*/ ctx[0] ? "+" : "") + "")) set_data_dev(t7, t7_value);

    			if (dirty & /*isNegative*/ 1 && span2_class_value !== (span2_class_value = "" + (null_to_empty(/*isNegative*/ ctx[0] ? "positive" : "negative") + " svelte-8rgi1h"))) {
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	validate_slots("DashboardInfo", slots, []);
    	let { data } = $$props;
    	const yAccessor = d => d.price;
    	const monthHigh = max(data, yAccessor).toLocaleString("en", { minimumFractionDigits: 2 });
    	const monthLow = min(data, yAccessor).toLocaleString("en", { minimumFractionDigits: 2 });
    	const currentPrice = yAccessor(data[data.length - 1]).toLocaleString("en", { minimumFractionDigits: 2 });
    	const percentageChange = Number(((yAccessor(data[data.length - 1]) - yAccessor(data[data.length - 2])) / yAccessor(data[data.length - 2]) * 100).toFixed(2));
    	...
    	Object.keys($$props).forEach(key => {
    		if (!~writable_props.indexOf(key) && key.slice(0, 2) !== "$$") console.warn(`<DashboardInfo> was created with unknown prop '${key}'`);
    	});
    	...
    	$$self.$inject_state = $$props => {
    		if ("data" in $$props) $$invalidate(5, data = $$props.data);
    		if ("isNegative" in $$props) $$invalidate(0, isNegative = $$props.isNegative);
    	};
    	...
    	return [isNegative, monthHigh, monthLow, currentPrice, percentageChange, data];
    }

    class DashboardInfo extends SvelteComponentDev {
    	constructor(options) {
    		super(options);
    		...
    		if (/*data*/ ctx[5] === undefined && !("data" in props)) {
    			console.warn("<DashboardInfo> was created without expected prop 'data'");
    		}
    	}

    	get data() {
    		throw new Error("<DashboardInfo>: Props cannot be read directly from the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}

    	set data(value) {
    		throw new Error("<DashboardInfo>: Props cannot be set directly on the component instance unless compiling with 'accessors: true' or '<svelte:options accessors/>'");
    	}
    }

    /* src/components/LineChart.svelte generated by Svelte v3.31.2 */
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(div, file$1, 158, 0, 3998);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	function drawChart(dataset) {
    		...
    		// Wrapper
    		const wrapper = select("#wrapper").append("svg").attr("width", dimensions.width).attr("height", dimensions.height);

    		// Gradient
    		const defs = select("svg").append("defs");

    		const gradient = defs.append("linearGradient").attr("id", "svgGradient");
    		gradient.append("stop").attr("class", "start").attr("offset", "0%").attr("stop-color", "white").attr("stop-opacity", 1);
    		gradient.append("stop").attr("class", "end").attr("offset", "100%").attr("stop-color", "white").attr("stop-opacity", 0);

    		// Bounds
    		const bounds = wrapper.append("g").style("transform", `translate(${dimensions.margin.left}px, ${dimensions.margin.top}px)`);

    		// Scales
    		const yScale = linear$2().domain(extent(dataset, yAccessor)).range([dimensions.boundedHeight, 0]).nice();

    		const xScale = time().domain(extent(dataset, xAccessor)).range([0, dimensions.boundedWidth]);

    		// Area Generator
    		const areaGenerator = area$3().x(d => xScale(xAccessor(d))).y0(dimensions.boundedHeight).y1(d => yScale(yAccessor(d)));

    		bounds.append("path").attr("d", areaGenerator(dataset)).attr("fill", "#eeecfa");

    		// Line Generator
    		const lineGenerator = line().x(d => xScale(xAccessor(d))).y(d => yScale(yAccessor(d)));

    		bounds.append("path").attr("d", lineGenerator(dataset)).attr("fill", "none").attr("stroke", "#695eb6").attr("stroke-width", 1);
    		...
    		// Price level line
    		bounds.append("line").style("stroke", "hsl(248, 38%, 54%, 0.4)").style("stroke-width", 1).attr("x1", 0).attr("y1", yScale(yAccessor(dataset[dataset.length - 1]))).attr("x2", xScale(xAccessor(dataset[dataset.length - 1]))).attr("y2", yScale(yAccessor(dataset[dataset.length - 1])));

    		bounds.append("circle").style("fill", "#eeecfa").style("stroke", "hsla(195, 100%, 50%, 0.4)").style("stroke-width", 5).attr("cx", xPoint).attr("cy", yPoint).attr("r", 4);
    		bounds.append("circle").style("fill", "#eeecfa").style("stroke", "#695eb6").attr("cx", xPoint).attr("cy", yPoint).attr("r", 3);

    		// Gradient Rect
    		bounds.append("rect").style("fill", "url(#svgGradient)").attr("x", 0).attr("y", 0).attr("width", 50).attr("height", dimensions.boundedHeight);

    		// Axes
    		const yAxisGenerator = axisLeft().scale(yScale).ticks(5);

    		bounds.append("g").attr("class", "yaxis").call(yAxisGenerator);
    	...
    	$$self.$capture_state = () => ({ d3, onMount, data, drawChart });
    ...
    /* src/components/Text.svelte generated by Svelte v3.31.2 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			p0 = element("p");
    			p0.textContent = "30 day price history (Source: Coindesk API)";
    			t1 = space();
    			p1 = element("p");
    			p1.textContent = "Bitcoin(₿) is a cryptocurrency invented in 2008 by an unknown person or\n    group of people using the name Satoshi Nakamoto. The currency began use in\n    2009 when its implementation was released as open-source software. Bitcoin\n    is a decentralized digital currency, without a central bank or single\n    administrator that can be sent from user to user on the peer-to-peer bitcoin\n    network without the need for intermediaries.";
    			attr_dev(p0, "class", "svelte-kg41nv");
    			add_location(p0, file$2, 4, 2, 28);
    			attr_dev(p1, "class", "svelte-kg41nv");
    			add_location(p1, file$2, 5, 2, 81);
    			attr_dev(div, "class", "svelte-kg41nv");
    ...
    "2021-01-10": 38191.55,
    "2021-01-11": 35463.1883,
    "2021-01-12": 34059.9133,
    "2021-01-13": 37375.8033,
    "2021-01-14": 39138.075,
    "2021-01-15": 36770.0433,
    "2021-01-16": 36029.1967,
    "2021-01-17": 35845.0217,
    "2021-01-18": 36656.9933,
    "2021-01-19": 35929.1683,
    "2021-01-20": 35510.67,
    "2021-01-21": 30838.5,
    "2021-01-22": 33018.825,
    };

    /* src/components/Dashboard.svelte generated by Svelte v3.31.2 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			create_component(dashboardinfo.$$.fragment);
    			t0 = space();
    			create_component(linechart.$$.fragment);
    			t1 = space();
    			create_component(text_1.$$.fragment);
    			attr_dev(div, "class", "svelte-yeie0p");
    			add_location(div, file$3, 22, 0, 543);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			insert_dev(target, div, anchor);
    			mount_component(dashboardinfo, div, null);
    			append_dev(div, t0);
    		...
    		i: function intro(local) {
    			if (current) return;
    			transition_in(dashboardinfo.$$.fragment, local);
    			transition_in(linechart.$$.fragment, local);
    			transition_in(text_1.$$.fragment, local);
    			current = true;
    		},
    		o: function outro(local) {
    			transition_out(dashboardinfo.$$.fragment, local);
    		...
    		d: function destroy(detaching) {
    			if (detaching) detach_dev(div);
    			destroy_component(dashboardinfo);
    ...
    function instance$3($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		...
    		if ("datasetBackup" in $$props) $$invalidate(1, datasetBackup = $$props.datasetBackup);
    	};
    	...
    	return [dataset, datasetBackup, data];
    }
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			attr_dev(div, "class", "panel svelte-1ii4dwd");
    ...
    function create_if_block(ctx) {
    	...
    	let panel1;
    	let current;
    	panel0 = new Panel({ $$inline: true });

    	dashboard = new Dashboard({
    			props: { data: /*data*/ ctx[0].bpi },
    			$$inline: true
    		});

    	panel1 = new Panel({ $$inline: true });
    	...
    	const block = {
    		...
    		p: function update(ctx, dirty) {
    			...
    			if (dirty & /*data*/ 1) dashboard_changes.data = /*data*/ ctx[0].bpi;
    ...
    function create_fragment$5(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(main, "class", "svelte-16k45tf");
    			add_location(main, file$5, 15, 0, 333);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$5($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Dashboard, Panel, onMount, data });
